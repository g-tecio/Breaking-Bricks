...
//            self.addChild(scoreControls.scoreWinLabel)
//            
//            scoreControls.scoreWinLabel.fontColor = .gray
//            scoreControls.scoreLoseLabel.fontColor = .gray
//            scoreControls.scoreTimeLabel.fontColor = .gray
//            
//        }
//        if sceneNumber == 4{
//            
...
//            self.addChild(scoreControls.scoreWinLabel)
//            
//            scoreControls.scoreWinLabel.fontColor = .yellow
//            scoreControls.scoreLoseLabel.fontColor = .yellow
//            scoreControls.scoreTimeLabel.fontColor = .yellow
//            
//        }
