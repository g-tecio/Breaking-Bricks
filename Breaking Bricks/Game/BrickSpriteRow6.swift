        ...
        if (deviceType == .iPad || deviceType == .iPad2 || deviceType == .iPadMini || UIDevice.current.userInterfaceIdiom == .phone ){
            ...
            if (screenSize == CGRect(x: 0.0, y: 0.0, width: 375.0, height: 812.0)) {
                ...
                blockclassic.position = CGPoint(
                    x: ((inThisScene.size.width * 9.95/100) + (blockclassic.size.width * (106.25/100)) * CGFloat(col))
                    ,y: (inThisScene.size.height * 77.62/100) - ((blockclassic.size.height * (225/100) ) * CGFloat(row))
                )
            ...
            if (screenSize == CGRect(x: 0.0, y: 0.0, width: 414.0, height: 896.0)) {
                ...
                blockclassic.position = CGPoint(
                    x: ((inThisScene.size.width * 11.75/100) + (blockclassic.size.width * (106.25/100)) * CGFloat(col))
                    ,y: (inThisScene.size.height * 76.86/100) - ((blockclassic.size.height * (225/100) ) * CGFloat(row))
                )
                retroLifeSkin.size = blockclassic.size
                retroLifeSkin.position = blockclassic.position
