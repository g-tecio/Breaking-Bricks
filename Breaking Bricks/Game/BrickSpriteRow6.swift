...
struct BrickSpriteRow6 {
    ...
    init (numBricks: Int, row: Int, col: Int , inThisScene: GameScene) {
        ...
        //
        //        rainbowSkin.size = CGSize(width:(rainbowSkin.size.width * (inThisScene.size.width / rainbowSkin.size.width ) * (15/100)) ,
        ...
        //
        //        lightSkin.size = CGSize(width:(lightSkin.size.width * (inThisScene.size.width / lightSkin.size.width ) * (15/100)) ,
