...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        if(sceneNumber == 6){
            ...
            // Background and paddle
            self.addChild(gameControls.endTimesBackground)
            self.addChild(gameControls.endTimesPaddle)
            // Bricks
            self.addChild(gameControls.endTimesScore)
            self.addChild(gameControls.endTimesTimer)
            // Label
            self.addChild(gameControls.timerLabel)
            self.addChild(gameControls.scoreLabel)
            // Color label
            ...
            //Paddle and ball
            let ball = gameControls.endTimesBall
            let paddle = gameControls.endTimesPaddle
            ...
            self.addChild(gameControls.endTimesBall)
        ...
        if(sceneNumber == 7){
            ...
            // Background and paddle
            self.addChild(gameControls.pumpkinBackground)
            self.addChild(gameControls.pumpkinPaddle)
            // Bricks
            self.addChild(gameControls.pumpkinScore)
            self.addChild(gameControls.pumpkinTimer)
            // Label
            self.addChild(gameControls.timerLabel)
            self.addChild(gameControls.scoreLabel)
            // Color label
            ...
            //Paddle and ball
            let ball = gameControls.pumpkinBall
            let paddle = gameControls.pumpkinPaddle
        ...
        if(sceneNumber == 11 ){
            ...
            // Background and paddle
            self.addChild(gameControls.dessertBackground)
            self.addChild(gameControls.dessertPaddle)
            // Bricks
            self.addChild(gameControls.dessertScore)
            self.addChild(gameControls.dessertTimer)
            // Label
            self.addChild(gameControls.timerLabel)
            self.addChild(gameControls.scoreLabel)
            // Color label
            ...
            //Paddle and ball
            let ball = gameControls.dessertBall
            let paddle = gameControls.dessertPaddle
            ...
            self.addChild(gameControls.dessertBall)
        ...
        if(sceneNumber == 12 ){
            ...
            // Background and paddle
            self.addChild(gameControls.classyBackground)
            self.addChild(gameControls.classyPaddle)
            // Bricks
            self.addChild(gameControls.classyScore)
            self.addChild(gameControls.classyTimer)
            // Label
            self.addChild(gameControls.timerLabel)
            self.addChild(gameControls.scoreLabel)
            // Color label
            ...
            //Paddle and ball
            let ball = gameControls.classyBall
            let paddle = gameControls.classyPaddle
            ...
            self.addChild(gameControls.classyBall)
